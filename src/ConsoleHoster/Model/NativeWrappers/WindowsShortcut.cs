//-----------------------------------------------------------------------
// <copyright file="WindowsShortcut.cs" author="Artak Mkrtchyan">
//     
// </copyright>
...
{
	public class WindowsShortcut : IDisposable
	{
		...
		/// </summary>
		[Flags]
		public enum ShortcutResolveFlags : uint
		{
			/// <summary>
		...
		public enum ShortcutDisplayMode : uint
		{
		...
		public WindowsShortcut(string linkFile)
			: this()
		{
			Open(linkFile);
		}
		...
		/// run
		/// </summary>
		public ShortcutDisplayMode DisplayMode
		{
			get
			{
				uint cmd = 0;
				...
				return (ShortcutDisplayMode)cmd;
			}
			set
			{
				if (linkA == null)
			...
			)
		{
			Open(linkFile,
				IntPtr.Zero,
				(ShortcutResolveFlags.SLR_ANY_MATCH | ShortcutResolveFlags.SLR_NO_UI),
				1);
		}
		...
		public void Open(
			string linkFile,
			IntPtr hWnd,
			ShortcutResolveFlags resolveFlags
			)
		{
			Open(linkFile,
				hWnd,
			...
			)
		{
			...
			if ((resolveFlags & ShortcutResolveFlags.SLR_NO_UI)
				== ShortcutResolveFlags.SLR_NO_UI)
			{
